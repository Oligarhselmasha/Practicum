...
public class Practicum {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Уровень кислорода: " + spaceStation.getOxygenLevel()); // Здесь переданые значения
        System.out.println("Уровень энергии: " + spaceStation.getEnergyReserve()); // Здесь переданые значения
        System.out.println("Потребление энергии: " + spaceStation.getEnergyConsumption()); //значение из конструктора ISS
        System.out.println("Уровень топлива: " + spaceStation.fuel); // Здесь переданые значения

        System.out.println("\nСтыковка нового модуля...");

        Zvezda newModule = new Zvezda();

        spaceStation.moduleDocking(newModule); // вызываем метод ISS, передаем туда Zvezda
